...
class MenuRepository():
    ...
    async def add(self, entity: Menu):
        '''Add new menu'''
        try:
            query = """INSERT INTO SYS_MENU(MN_CODE, MN_NAME, MN_ICON, MN_PARENT, MN_PREFIX, MN_LINK, MN_ADMIN_SITE, CREATED_ON_UTC, UPDATED_ON_UTC)
                    VALUES(:V_CODE, :V_NAME, :V_ICON, :V_PARENT, :V_PREFIX, :V_LINK, :V_ADMIN_SITE,
            ...
            return await self.db_context.execute_query(query, {
                ...
                "V_PREFIX" : entity.prefix,
                "V_LINK": entity.route,
                "V_ADMIN_SITE": entity.admin_site,
